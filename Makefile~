...
PROGNAME = FirstGBAGame

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o mylib.o font.o text.o splashScn.o orion.o player.o blueInvader.o greenInvader.o redInvader.o moon.o winscrn.o gameoverscrn.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h splashScn.h orion.h player.h blueInvader.h greenInvader.h redInvader.h moon.h winscrn.h gameoverscrn.h
